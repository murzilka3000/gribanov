  ...
  return (
    <div className={s.hero}>
      <HomeBigCard
        ...
        intro="ЦЕХ — это экосистема! Мы работаем в сфере медиа-контента и развиваем другие направления в области кино — от дополнительного образования до аренды съемочных локаций."
