  ...
  return (
    <>
      <main className={s.privacyPage}>
        <section className={clsx("section_padding", s.privacy)}>
            ...
            <div className={s.content}>
              <div className={s.section}>
                ...
                <p>
                  ...
                  предпринимаемые ООО «Грибанов и Партнеры» (далее — Оператор).
                </p>
                <p>
              ...
              <div className={s.section}>
                ...
                <p>
                  Цель: предоставление доступа Пользователю к сервисам,
                  информации и/или материалам, содержащимся на веб-сайту.
                </p>
                <p>Персональные данные: фамилия, имя, отчество, фотографии.</p>
                <p>
              ...
              <div className={s.section}>
                ...
                <p>
                  ...
                  целей, предусмотренных международным договором РФ или законом.
                </p>
              </div>
              ...
              <div className={s.section}>
                ...
                <p>
                  ...
                  актуализировать их, направив уведомление на
                  gribanov@frankrg.com.
                </p>
                <p>
                  8.4. Срок обработки определяется достижением целей сбора.
                  Пользователь может отозвать согласие через почту
                  gribanov@frankrg.com.
                </p>
              </div>
              ...
              <div className={s.section}>
                ...
                <p>
                  12.1. Пользователь может получить любые разъяснения по почте
                  gribanov@frankrg.com.
                </p>
                <p>
                  12.2. Политика действует бессрочно до замены ее новой версией.
                  Актуальная версия расположена по адресу
                  https://gribanov.com/privacy/.
                </p>
              </div>
            </div>
          </div>
